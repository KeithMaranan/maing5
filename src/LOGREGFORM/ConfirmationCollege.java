...
public class ConfirmationCollege extends javax.swing.JFrame {

    public ConfirmationCollege() {
        initComponents();
        setUndecorated(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmationCollege.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmationCollege().setVisible(true);
            }
        });
    }
