...
public class Academics extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.setBackground(new java.awt.Color(60, 80, 110));
        ...
        jPanel7.setBackground(new java.awt.Color(60, 66, 130));
        ...
        jLabel6.setFont(new java.awt.Font("Papyrus", 0, 20)); // NOI18N
        jLabel6.setText("Welcome to Cloud Nine Academy School");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(410, 120, 361, 32);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(240, 160, 723, 19);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(280, 190, 590, 19);
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(430, 220, 284, 19);

        jLabel10.setFont(new java.awt.Font("Papyrus", 0, 20)); // NOI18N
        jLabel10.setText("Our staff");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(560, 320, 85, 32);
        ...
        jLabel11.setBounds(260, 350, 709, 19);

        jLabel12.setFont(new java.awt.Font("Microsoft YaHei UI Light", 0, 14)); // NOI18N
        jLabel12.setText("experienced and certified teachers, along with a strong support staff.");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(390, 380, 425, 19);

        jLabel13.setFont(new java.awt.Font("Microsoft YaHei UI Light", 0, 14)); // NOI18N
        jLabel13.setText("We believe that every student has the ability to learn and grow, and we are devoted to providing them with");
        jPanel1.add(jLabel13);
        jLabel13.setBounds(280, 420, 667, 19);

        jLabel14.setFont(new java.awt.Font("Microsoft YaHei UI Light", 0, 14)); // NOI18N
        jLabel14.setText("the resources they need to succeed.");
        jPanel1.add(jLabel14);
        jLabel14.setBounds(470, 450, 229, 19);

        jLabel15.setFont(new java.awt.Font("Papyrus", 0, 20)); // NOI18N
        jLabel15.setText("Our Community");
        jPanel1.add(jLabel15);
        jLabel15.setBounds(520, 530, 143, 41);
        ...
        jLabel16.setBounds(270, 570, 708, 19);
        ...
        jLabel17.setBounds(350, 600, 515, 19);
        ...
        jLabel18.setBounds(370, 630, 446, 19);
